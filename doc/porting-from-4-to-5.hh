...
///
/// \section hpp_manipulation_corba_porting_4_to_5 Porting your code from
/// version 4 to version 5 \subsection hpp_manipulation_corba_porting_4_to_5_1
...
///
/// Arguments
/// \li in string packageName, in string modelName, in string urdfSuffix, in
/// string srdfSuffix have been replaced by \li in string urdfname, in string
/// srdfname.
///
/// These latter arguments contain the full filename to the urdf and srdf files.
/// They may include "package://" pattern.
///
/// \subsection hpp_manipulation_corba_porting_4_to_5_2 Modification in python
/// API \subsubsection hpp_manipulation_corba_porting_4_to_5_2_1 Methods
///
/// \li insertRobotModel,
